                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="assets/images/faces/face1.jpg" className="me-2" alt={''} /> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face2.jpg" className="me-2" alt={''} /> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face3.jpg" className="me-2" alt={''} /> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="assets/images/faces/face4.jpg" className="me-2" alt={''}/> John Doe
                            </td>
                  ...
                  <div className="card-body">
                    ...
                    <div className="row mt-3">
                      <div className="col-6 pe-1">
                        <img src="assets/images/dashboard/img_1.jpg" className="mb-2 mw-100 w-100 rounded" alt={''} />
                        <img src="assets/images/dashboard/img_4.jpg" className="mw-100 w-100 rounded" alt={''} />
                      </div>
                      <div className="col-6 ps-1">
                        <img src="assets/images/dashboard/img_2.jpg" className="mb-2 mw-100 w-100 rounded" alt={''} />
                        <img src="assets/images/dashboard/img_3.jpg" className="mw-100 w-100 rounded" alt={''} />
                      </div>
                    </div>
                    <div className="d-flex mt-5 align-items-top">
                      <img src="assets/images/faces/face3.jpg" className="img-sm rounded-circle me-3" alt={''} />
                    ...
                    <div className="list-wrapper">
                      <ul className="d-flex flex-column-reverse todo-list todo-list-custom">
                        ...
                        <li className="completed">
                          <div className="form-check">
                            <label className="form-check-label">
                              <input className="checkbox" type="checkbox" checked={true} /> Call John </label>
                          </div>
                          <i className="remove mdi mdi-close-circle-outline" />
                        </li>
                        <li>
                        ...
                        <li className="completed">
                          <div className="form-check">
                            <label className="form-check-label">
                              <input className="checkbox" type="checkbox" checked={true} /> Prepare for presentation </label>
                          </div>
                          <i className="remove mdi mdi-close-circle-outline" />
                        </li>
                        <li>
